...
**Fake Yelp** is a Yelp search app using the [Yelp API](http://www.yelp.com/developers/documentation/v2/search_api).
...
<img src='https://imgur.com/4bMPyio.gif' title='Video Walkthrough' width='' alt='Video Walkthrough' />
